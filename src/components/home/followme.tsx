...
function FollowMe() {
    return (
        <div className='text-center pt-32 md:pt-64 mx-auto md:w-3/5' id="testing">
            ...
            <p className='text-gray-400 mt-5' data-aos="fade-right" data-aos-duration="2000">Follow me on Social Media to get update about my socila and professional life<br/> <br/>
            </p>
            <div>
